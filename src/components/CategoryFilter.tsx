    ...
    <div className="sticky top-0 z-30 bg-black/40 backdrop-blur-md border-b border-white/10 pt-2 sm:pt-3">
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 p-4 sm:p-5 max-w-7xl mx-auto">
        ...
        <div className="relative flex-1" ref={categoryRef}>
          ...
          {showCategories && (
            <div className="absolute top-full left-0 right-0 mt-3 bg-black/95 backdrop-blur-xl rounded-2xl shadow-2xl z-[9999] border border-white/20 overflow-hidden animate-fadeIn">
              {/* En-tête du dropdown */}
              <div className="px-5 py-4 bg-white/10 border-b border-white/20">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white/60 text-sm font-medium bg-white/10 px-2 py-1 rounded-lg">{categories.length - 1}</span>
                </div>
              </div>
              ...
              <div className="max-h-60 sm:max-h-64 lg:max-h-72 overflow-y-auto scrollbar-thin scrollbar-thumb-blue-500/30 scrollbar-track-transparent">
                {categories.map((category, index) => (
                  <button
                    ...
                    className={`w-full text-left px-5 py-4 text-sm text-white hover:bg-white/10 transition-all duration-200 border-b border-white/10 last:border-b-0 group ${
            ...
            <div className="absolute top-full left-0 right-0 mt-3 bg-black/95 backdrop-blur-xl rounded-2xl shadow-2xl z-[9999] border border-white/20 overflow-hidden animate-fadeIn">
              ...
              <div className="px-5 py-4 bg-white/10 border-b border-white/20">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-white/60 text-sm font-medium bg-white/10 px-2 py-1 rounded-lg">{farms.length - 1}</span>
                </div>
              </div>
